...
import shoeportal.cart.CartDao;
import shoeportal.categories.Categories;
import shoeportal.categories.CategoriesDao;
import shoeportal.product.Product;
import shoeportal.product.ProductDao;
import shoeportal.users.Users;
import shoeportal.users.UsersDao;

@Controller
public class shoeportalController {
	// AUTOWIRED CLASSES //
	@Autowired
	CategoriesDao cdao;
	 ...
	 * ModelAndView upload(@RequestParam CommonsMultipartFile file,HttpSession
	 * session){ String path=session.getServletContext().getRealPath("/"); String
	 * filename=file.getOriginalFilename();
	 * 
	 * 
	 * System.out.println(path+" "+filename); try{ byte barr[]=file.getBytes();
	 * 
	 ...
	 * ModelAndView("upload-success","filename",path+"/"+filename); }
	 */
	////////////////////////////// CATEGORY UPDATE
	////////////////////////////// /////////////////////////////////////////
