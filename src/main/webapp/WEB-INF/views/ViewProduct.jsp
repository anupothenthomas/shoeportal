...
<head>
  ...
  <!-- Custom styles for this template -->
    <link href="resources/assets/css/shop-homepage.css" rel="stylesheet">
	...
	<table
		...
		<tbody>
			...
			<c:forEach items="${prolist}" var="x">
				<tr>
					<td
						style="border-left: solid 1px white; border-bottom: solid 1px white; color: white">${x.getId()}</td>
					<td
						style="border-left: solid 1px white; border-bottom: solid 1px white; color: white">
					...
					<td
						style="border-left: solid 1px white; border-bottom: solid 1px white; color: white">${x.getDescription()}</td>
					<td
						style="border-left: solid 1px white; border-bottom: solid 1px white; color: white">${x.getPrice() }</td>
						<td
						style="border-left: solid 1px white; border-bottom: solid 1px white; color: white">${x.getBrand() }</td>
						<td
						style="border-left: solid 1px white; border-bottom: solid 1px white; color: white">${x.getQuantity() }</td>
					<td
						style="border-left: solid 1px white; border-bottom: solid 1px white; color: white"><img
						src="${x.imageUrl}" style="height: 100px; width: 100px" /></td>
					<td
						style="border-left: solid 1px white; border-bottom: solid 1px white; color: white"><a
