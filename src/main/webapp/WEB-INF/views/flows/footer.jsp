			...
			<footer id="footer">
				<div class="container">
					<ul class="icons">
						...
						<li><a href="https://outlook.live.com/owa/" class="icon fa-envelope-o" target="_blank"><span class="label">Email</span></a></li>
					</ul>
				</div>
				<div class="copyright">
					developed by Kregzen&copy; ShoePortal&trade;	All rights reserved.
				</div>
			</footer>
</body>
</html>