...
<title>ShoepPortal:Login</title>
	...
	<!-- Custom Theme files -->
	<link href="resources/assets/css1/style.css" rel="stylesheet" type="text/css" media="all" />
	<link href="resources/assets/css1/font-awesome.css" rel="stylesheet"> <!-- Font-Awesome-Icons-CSS -->
	<!-- //Custom Theme files -->
