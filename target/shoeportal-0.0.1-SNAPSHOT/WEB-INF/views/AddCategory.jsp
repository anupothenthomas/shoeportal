...
<body style="background-color: black;">
	...
	<form:form style="margin: auto; width: 80%; text-align:center;"
		...
		<br>
		<h1
			style="color: white; text-transform: Uppercase; margin: auto; width: 80%; text-align: center;">Add
			Category</h1>
		<br>

		<form:input style=" color:white; " path="name" required=""
			placeholder="Enter Category Name" class="form-control" />

		<br>

		<form:input style="resize: none; color:white;" path="description"
